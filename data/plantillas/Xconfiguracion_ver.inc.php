...
<div id="ver_info">
	...
	<div class="bloque_info">
		...
		<div class="capa_tab"> 
			<input type="reset" value=" <?php echo $PFN_conf->t('voltar'); ?> " class="boton" onclick="enlace('resumo.php?<?php echo PFN_cambia_url('id', $id, false); ?>');" />
			<?php if ($editar) { ?>
			<input type="button" value=" <?php echo $PFN_conf->t('editar'); ?> " class="boton" style="margin-left: 40px;" onclick="enlace('editar.php?<?php echo PFN_cambia_url('id', $id, false); ?>');" />
			...
			<br /><input type="reset" value=" <?php echo $PFN_conf->t('voltar'); ?> " class="boton" onclick="enlace('resumo.php?<?php echo PFN_cambia_url('id', $id, false); ?>');" />
			<?php if ($editar) { ?>
			<input type="button" value=" <?php echo $PFN_conf->t('editar'); ?> " class="boton" style="margin-left: 40px;" onclick="enlace('editar.php?<?php echo PFN_cambia_url('id', $id, false); ?>');" />
			<?php if ($PFN_usuarios->get('vale')) { ?>
			<input type="button" value=" <?php echo $PFN_conf->t('eliminar'); ?> " class="boton" style="margin-left: 40px;" onclick="eliminar();" />
