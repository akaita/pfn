...
?>
<div id="ver_info">
	<div class="bloque_info"><h1><?php echo PFN___('xestion').' &raquo; '.PFN___('Xadmin_raices'); ?></h1></div>
				...
				<fieldset>
					...
					<table class="Xmenu" summary="">
						...
						<tr class="trarq<?php echo $on; ?>">
							...
							<td class="centro">
								<select id="estado_<?php echo $id; ?>" name="estado[<?php echo $id; ?>]">
