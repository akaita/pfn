...
?>
<div id="ver_info">
	<div class="bloque_info"><h1><?php echo PFN___('xestion').' &raquo; '.PFN___('Xadmin_usuarios'); ?></h1></div>
			...
			<form action="<?php echo PFN_cambia_url(array('buscar','paxina','paxinar'), array($buscar, $paxina, $paxinar)); ?>" method="post" onsubmit="return submitonce();">
				<fieldset>
					...
					<table class="Xmenu" summary="">
						...
						<?php } ?>
						<tr>
							<td colspan="5" class="centro"><br /><input type="submit" value="<?php echo PFN___('Xcambiar'); ?>" class="boton" /></td>
						</tr>
					</table>
