			...
			<form action="gdar.php?<?php echo PFN_get_url(false); ?>" method="post" enctype="multipart/form-data" onsubmit="return validar_campos();">
				<fieldset>
					...
					<table class="tabla_info" summary="">
						...
						<tr>
							<th><a href="#" onclick="Xamosa_axuda(14); return false;">(?)</a> <label for="id_control"><?php echo $PFN_conf->t('Xcodigo_acceso'); ?></label></th>
						...
						<tr id="tr_axuda14" style="display: none;">
							<td colspan="2"><?php echo $PFN_conf->t('Xaxuda','usuario_codigo_acceso'); ?></td>
						</tr>
						<tr>
						...
						<tr>
							<th><a href="#" onclick="Xamosa_axuda(15); return false;">(?)</a> <label for="login_usuario"><?php echo $PFN_conf->t('Xmodo_acceso'); ?></label></th>
							<td>
								...
								<label for="login_usuario" style="margin-right: 20px;"><?php echo $PFN_conf->t('Xcon_usuario_contrasinal'); ?></label>
								...
								<label for="login_certificado"><?php echo $PFN_conf->t('Xcon_certificado'); ?></label>
							</td>
						</tr>
						<tr id="tr_axuda15" style="display: none;">
							<td colspan="2"><?php echo $PFN_conf->t('Xaxuda','usuario_modo_acceso'); ?></td>
						</tr>
					</table>
			
					<br /><br />
			
					<h2><?php echo $PFN_conf->t('Xraices_relacionadas'); ?></h2>
					...
					<div style="width: 100%; text-align: center;">
						<?php if (!empty($id)) { ?>
						<input type="reset" value=" <?php echo $PFN_conf->t('eliminar'); ?> " class="boton" style="margin-right: 40px;" onclick="eliminar();" tabindex="300" />
						<?php } ?>
						<input type="reset" value=" <?php echo $PFN_conf->t('voltar'); ?> " class="boton" style="margin-right: 40px;" onclick="enlace('index.php');" tabindex="310" />
						<input type="submit" value="<?php echo $PFN_conf->t('aceptar'); ?>" class="boton" tabindex="320" />
					</div>
				</fieldset>
			</form>
		</div>
