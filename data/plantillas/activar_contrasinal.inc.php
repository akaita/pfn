...
<h1 id="benvido"><span><?php echo $PFN_conf->t('novo_contrasinal'); ?></span></h1>
...
<div id="login">
	<form action="activar_contrasinal.php" method="post" id="formulario">
		<fieldset>
			...
			<p>
				<label for="activar_usuario"><?php echo $PFN_conf->t('usuario'); ?>:</label>
				<br /><input type="text" id="activar_usuario" name="activar_usuario" class="formulario" />
			</p>

			<p>
				<label for="activar_contrasinal"><?php echo $PFN_conf->t('novo_contrasinal'); ?>:</label>
...
<div id="login_mais_opcions">
	<a href="index.php"><?php echo $PFN_conf->t('voltar'); ?></a>
</div>
